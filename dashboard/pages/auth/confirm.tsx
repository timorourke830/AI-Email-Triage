...
/**
 * Email confirmation page for PKCE flow.
 * Handles signup email verification and other confirmation types.
 *
 * For password recovery, Supabase redirects directly to /auth/reset-password
 * with the token in URL params, so this page doesn't handle recovery.
 */
